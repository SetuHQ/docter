...
const defaultTheme: ThemeInterface = {
    ...
    colors: {
        tonalOffset: 0.3,
        primary: {
            main: setuColours.flashTurk,
            light: ({ colors }) => lighten(colors.tonalOffset, colors.primary.main),
            dark: setuColours.flashTurk,
    ...
    schema: {
        ...
        nestingSpacing: '1em',
        nestedBackground: ({ rightPanel }) => rightPanel.backgroundColor,
        arrow: {
            size: '1.1em',
    ...
    typography: {
        ...
        code: {
            ...
            color: setuColours.fadedMing,
            backgroundColor: 'rgba(141,177,209,0.2)',
            wrap: false,
        },
        links: {
    ...
    sidebar: {
        ...
        textColor: setuColours.fadedMing,
        groupItems: {
    ...
    codeBlock: {
        backgroundColor: ({ rightPanel }) => darken(0.035, rightPanel.backgroundColor),
    }
};
